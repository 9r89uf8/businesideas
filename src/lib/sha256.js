// A small synchronous SHA-256 implementation using only deterministic Web
// Platform primitives. Workflow orchestration cannot import Node's crypto
// module, while the public ranking/fingerprint helpers intentionally stay
// synchronous.
